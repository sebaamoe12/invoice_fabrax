...
const InvoicePreview = forwardRef<HTMLDivElement, InvoicePreviewProps>(({ data }, ref) => {
  ...
  const calculateLineTotals = () => {
    ...
    return sizes.map(size => ({
      size,
      quantity: data.quantities[size] || 0,
      total: (data.quantities[size] || 0) * UNIT_PRICE
    }));
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-6">
        <div className="text-4xl font-bold text-blue-600" style={{ fontFamily: 'Arial, sans-serif' }}>
          Fabrax
        </div>
        <div className="text-right">
          <span>Facture N° {data.invoiceNumber} | {data.invoiceDate}</span>
        </div>
      </div>
            ...
            <tbody>
              <tr>
                <td className="border-2 border-black p-2 text-center" colSpan={5}>
                  <strong>MONTANT TOTAL EN HT</strong>
                </td>
                <td className="border-2 border-black p-2 text-right">
                  {montantTotalHT.toFixed(2)}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="mt-2 flex justify-end">
          <table className="border-collapse" style={{ width: '50%' }}>
            <tbody>
              ...
              <tr className="bg-gray-100">
                <td className="border-2 border-black p-2 text-center">
                  <strong>MONTANT TOTAL EN TTC</strong>
                </td>
                <td className="border-2 border-black p-2 text-right">
                  {montantTotalTTC.toFixed(2)}
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div className="border-2 border-black p-3 mb-6">
        <div className="mb-1">
          <strong>Arrêtée la presenta facture à terme en toutes taxes comprises à la somme de :</strong>
        </div>
      ...
      <div className="mb-6">
        <div className="mb-2">
          <strong>Moyen De Livraison :</strong> Moyen Propres Du Client
        </div>
        <div className="flex justify-between">
          <div>
            <strong>Nom Du Chauffeur:</strong> .........................
          </div>
          <div>
            <strong>Recu Le :</strong> .........................
          </div>
        </div>
      </div>
